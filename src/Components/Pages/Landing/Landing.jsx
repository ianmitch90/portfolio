          ...
          <Parallax className='heroBackground' ref={ref => (this.parallax = ref)} pages={2}>
            ...
            <ParallaxLayer offset={1}>
              <Parallax className="container" ref="parallax" pages={5} horizontal scrolling={true}>
                ...
                <Page offset={0} gradient="pink" caption="Who I Am" first='Developer' second="&" third="Designer" fourth="-" fifth='to begin:' sixth='swipe or tap' onClick={() => this.scroll(1)} bgTitle='Hey there' isWelcomePanel='things' />
